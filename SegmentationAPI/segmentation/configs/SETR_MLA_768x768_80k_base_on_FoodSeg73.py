...
data_root = '/content/FoodSeg73/Images/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type='CustomDataset',
        data_root='./data/FoodSeg73/Images/',
        img_dir='img_dir/test',
        ann_dir='ann_dir/test',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = '/content/drive/Shareddrives/Food Analytic/models/Segmentation/SETR_MLA/onFoodSeg73/state_dict'
gpu_ids = range(0, 1)
seed=42
